...
public class AccountTester {
    ...
    public static void main(String[] args) {
        ...
        double newBal = a.finalBalance(balance,interest);
        if(bal>50)
        System.out.println("the final balance is" +newBal);
        else
            System.out.println("Balance cannot be displayed bacause account is not created");
